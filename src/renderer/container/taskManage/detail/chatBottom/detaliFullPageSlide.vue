<template>
    <div class="taskD-full-page-slide-wrapper">
        <transition name="fade" mode="out-in">
            ...
            <div v-else-if="fooderContent === 'more'" key="more">
                <More @itemClick="taskMoreItemClick" :taskLeaderValue="taskLeaderValue"/>
            </div>
        </transition>
    </div>
</template>
    ...
    export default{
        ...
        mounted() {
              if (!this.clickEmojiOrClickMore) {
                  ...
                  document.querySelector(".taskD-full-page-slide-wrapper").style.height = (deviceHeight * 0.4) + 'px'

              } else {
                  let deviceHeight = this.DetailWrapH
                  console.log("fullpage this.DetailWrapH",this.DetailWrapH)
                  document.querySelector(".taskD-full-page-slide-wrapper").style.height = (deviceHeight * 0.6) + 'px'
              }
        },
        methods: {
            taskMoreItemClick(type) {
                this.$emit('taskMoreItemClick', type)
            },
