    ...
    <div id="zongLan">
        ...
        <div v-if="fpIsOk=='true'">
            <div class="vux-form-preview weui-form-preview">
                <div style="padding:0px 6px;" class="weui-form-preview__bd">
                    <div class="weui-form-preview__item">
                        <label class="weui-form-preview__label">审批流标题：</label>
                        <span class="weui-form-preview__value">{{workflowData.workflow_name}}</span>
                    </div>
                    <div class="weui-form-preview__item">
                        <label class="weui-form-preview__label">审批流描述：</label>
                        <span class="weui-form-preview__value">{{workflowData.workflow_describe}}</span>
                    </div>

                    <div class="weui-form-preview__item">
                        <label class="weui-form-preview__label">参与人：</label>
                        <span class="weui-form-preview__value">
                        <span style="margin-left: 5px;" v-for="cyr in cyrData">{{cyr.user_name}}</span>
                    </span>
                    </div>
                    <div class="weui-form-preview__item">
                        <label class="weui-form-preview__label">发起人：</label>
                        <span class="weui-form-preview__value">{{workflowData.RealName}}</span>
                    </div>

                    <div v-if="workflowData.workflowType==='MODULE_TYPE_ZYK'" class="weui-form-preview__item">
                        <label class="weui-form-preview__label">凭证：</label>
                        <span class="weui-form-preview__value">
                            <a href="javascript:void(0);" @click="openPz">查看凭证</a>
                        </span>
                    </div>
                    <!--<div v-if="workflowData.workflowType==='TYPE_HR_QJ'" class="weui-form-preview__item">-->
                    <!--<label class="weui-form-preview__label">请假原因：</label>-->
                    <!--<span class="weui-form-preview__value">{{workflowData.hr_qj_reason}}</span>-->
                    <!--</div>-->
            ...
            <!-- 关联任务 -->
            <link-task-work v-if="workflowData.linkTaskIds!=undefined && workflowData.linkTaskIds!=''" ref="linkTaskForm"
