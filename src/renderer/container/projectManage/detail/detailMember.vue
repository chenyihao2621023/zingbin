                ...
                <div class="chengImg">
                    ...
                    <div class="chengAvatar">
                        <div v-for=" (cheng,index) in insertNew" :key="index" @click="chengyuanXQ(index)">
                            <span v-if="cheng.headImg" class="chengLfetGroup" >
                                 <avatar :size="'default'" shape="square"
                                         :src="getImageUrl(cheng.headImg,'./static/images/userDef_.jpg')"
                ...
                <div class="fuzeImg">
                    ...
                    <div class="fuzeAvatar">
                       <div v-for="(fuzeren,index) in insertNew2" :key="index" @click="fuzerenXQ(index)">
                           <span v-if="fuzeren.headImg" class="fuzeLfetGroup" >
                                <avatar :size="'default'" shape="square"
                                        :src="getImageUrl(fuzeren.headImg,'./static/images/userDef_.jpg')"
                                        style=" float: left;margin-top: 7px;margin-left: 7px;">
                                </avatar>
                           </span>
                           <span v-else>
  ...
  export default{
      ...
      methods: {
                  ...
                  if (this.subscribersRange) {
                      ...
                      for (let i = 0; i < arr2.length; i++) {
                          for (let j = 0;j < arr3.length;j++) {
                              if (arr3[j] === arr2[i]) {
                                  //添加,headImg属性
                                  _.each(this.buildFileUrl,(item, index) => {
          ...
          _getloadCardByCardId() {
              ...
              let url1 = "/ZingMH/ZDesk/projectManageBoard/mater/loadBoardEsById.action"
          ...
          onPicked(list) {
              ...
              let  url2 = "/ZingMH/ZDesk/projectManageBoard/mater/updateBoards.action";
...
//                       insertActivity请求
                  ...
                  .catch(err => {
                      this.$vux.toast.show({text: "updateBoard", type: "false"})
                  });
//               addMseReminder请求
//              let params3 = {
//              boardId: this.insertParams.boardId,
