    ...
    <el-container>
        <el-main class="flex-column">
            <div class="flex-between">
                ...
                <span>
                    <el-form label-width="80px" :inline="true" label-position="right" size="small">
                        <el-form-item>
                            <el-input v-model="searchText" clearable placeholder="" size="small"></el-input>
                        </el-form-item>
            ...
            <div style="height: 100%">
                <el-table :data="reserveTypeData" border style="width: 100%" height="100%" v-loading="showLoading">
        ...
        <div class="dialog">
            <el-dialog :title="title" :visible.sync="addConfigModal">
                <el-form :model="reserveTypeForm" :rules="rules" ref="reserveTypeForm" label-width="100px">
                    <el-input type="hidden" v-model="reserveTypeForm.configCode"></el-input>
                    <el-form-item label="序号" prop="serialNo">
                        <el-input v-model="reserveTypeForm.serialNo" min="0" type="number"
                                  onkeypress="return (/[\d]/.test(String.fromCharCode(event.keyCode)))"></el-input>
                    </el-form-item>
                    <el-form-item label="描述" prop="configValue">
                        <el-input v-model="reserveTypeForm.configValue"></el-input>
                    </el-form-item>
                </el-form>
                <div slot="footer" class="dialog-footer">
                    <el-button type="primary" @click="submitForm('reserveTypeForm')">提交</el-button>
    ...
    export default {
        ...
        methods: {
            initData() {
                ...
                self.$httpSilent
                    ...
                    .then(res => {
                        ...
                        if (res.data.success) {
                            self.reserveTypeData = res.data.data;
            ...
            editTheOne(index, row) {
                this.title = "编辑";
                this.reserveTypeForm = Object.assign({}, row);
                this.addConfigModal = true;
            },
            submitForm(ref) {
                let self = this;
                this.$refs[ref].validate((valid) => {
                    if (valid) {
                        ...
                        console.log("form", this.reserveTypeForm);
                        self.$httpSilent
                            .post(url, this.reserveTypeForm)
                            .then(res => {
