    ...
    <el-container>
        <el-main class="flex-column">
            <div class="flex-between">
                ...
                <span>
                    <el-input placeholder="请输入关键字" v-model="searchVal" clearable size="small" style="width: 345px">
                        <el-select v-model="searchType" slot="prepend" style="width: 120px" placeholder="请选择">
            ...
            <div style="height: 100%">
                <el-table :data="tableData" v-loading="showLoading" border style="width: 100%" @row-click="RowClick"
                          height="100%">
        ...
        <el-dialog :title="DiaTitle" :visible.sync="newAdd" width="30%" @close="closeDia('addData')">
            <el-form :model="addData" :rules="rules" ref="addData" label-width="20%" class="demo-ruleForm">
                ...
                <el-form-item label="维修原因" prop="configValue">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            modify() {
                this.newAdd = true;
                this.DiaTitle = '修改维修原因';
            },

            //删除维修原因
            delCur() {
                this.$confirm('是否删除该维修原因?', '提示', {
