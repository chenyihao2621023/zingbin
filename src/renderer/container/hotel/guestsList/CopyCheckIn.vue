<template>
    <div>
        <el-dialog :visible.sync="show" :before-close="handleClose" append-to-body>
                    ...
                    <el-row>
                        <el-col :span="formItemWidth">
                            <el-form-item label="预订人" prop="reserveId">
                                ...
                                <el-tag v-show="form.reserveId">
                                    {{form.reserveName}}
                                </el-tag>
                                <el-button class="button-new-tag" size="small" @click="addBookingPeople">+ 添加预订人</el-button>
                            </el-form-item>
                        </el-col>
                        <el-col :span="formItemWidth">
                    ...
                    <el-row>
                        ...
                        <el-col :span="formItemWidth">
                            <el-form-item v-if="form.customerType === '2'" label="会员名称" prop="customerId">
                                <el-select clearable v-model="form.customerId" @change="famatCustomerName" placeholder="请选择会员" size="small">
                            ...
                            <el-form-item v-if="form.customerType === '4'" label="协议单位" prop="customerId">
                                <!--<el-select v-model="form.customerId" clearable @change="famatCustomerName" placeholder="请选择协议单位" size="small">-->
                    ...
                    <el-row v-if="form.customerProperty ==='2'">
                        ...
                        <el-col :span="formItemWidth">
                            <el-form-item label="公付内容" prop="pubTradeCode">
                                <el-select clearable multiple v-model="form.pubTradeCode" placeholder="请选择公付内容" size="small">
                    ...
                    <el-row>
                        <el-col :span="formItemWidth">
                            <el-form-item label="入住时间" prop="enterTime">
                                <el-date-picker v-model="form.enterTime" value-format="yyyy-MM-dd HH:mm:ss" size="small"
                                                :type="dateType" :picker-options="disableTime01" placeholder="选择日期时间"></el-date-picker>
                            </el-form-item>
                        </el-col>
                        <el-col :span="formItemWidth">
        ...
        methods: {
                ...
                this.$httpSilent
                    ...
                    .then(function (res) {
                        ...
                        if (res.data.success) {
                            ...
                            self.form = self.processResData(res.data.data.hotelOrders);
                        } else {
            ...
            processResData (data) {
                let form = {
                    ...
                    reserveTypeDesc:data.reserveTypeDesc,
                    ...
                    pubTradeCode:data.pubTradeCode ? data.pubTradeCode.split(" ") : [],
                };
                return form;
            },
