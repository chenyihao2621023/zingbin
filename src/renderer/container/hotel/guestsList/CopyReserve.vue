<template>
    <div>
        <el-dialog :visible.sync="show" title="复制预订" :before-close="handleClose" append-to-body>
                    ...
                    <el-row v-if="form.customerProperty ==='2'">
                        ...
                        <el-col :span="formItemWidth">
                            <el-form-item label="公付内容" prop="pubTradeCode">
                                <el-select multiple clearable v-model="form.pubTradeCode" placeholder="请选择公付内容" size="small">
