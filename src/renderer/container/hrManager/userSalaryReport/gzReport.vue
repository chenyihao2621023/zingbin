    ...
    <div class="zytzReport">
        <div class="content" v-show="showModel == 'search'">
            ...
            <group  label-margin-right="2em" label-align="left">
               <cell title="职员名称" is-link :value="searchName" @click.native="selectPerson('user')"></cell>
               <cell title="部门名称" is-link :value="searchOrg" @click.native="selectPerson('org')"></cell>
    ...
    export default {
        ...
        methods:{
            getTableData(){
                ...
                if(this.searchOrg && this.searchOrg !== '请选择部门'){
                    params.orgCode = this.searchOrg
                }
            ...
            onPicked(list) {//选中人员的回调
                if(this.showTab[0] === 'org'){
                    let retData = list[0]
                    this.searchOrg = retData.title
                }
                if(this.showTab[0] === 'colleague'){
                    let retData = list[0]
