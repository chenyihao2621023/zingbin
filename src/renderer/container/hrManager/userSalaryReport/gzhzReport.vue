    ...
    <div class="zytzhzReport">
        <div class="content" v-show="showModel == 'search'">
            ...
            <group  label-margin-right="2em" label-align="left">
               <cell title="部门名称" is-link :value="searchOrgName" @click.native="selectPerson"></cell>
...
<script>
    ...
    export default {
        ...
        methods:{
            getTableData(){
                let url = "/zingbiz/hrManager/userSalaryReport/getSalarySummaryListByCompanyId"
                let params = {
                      pageNumber:1,
                      pageSize:9999
                }
                if(this.searchOrgName && this.searchOrgName !== '请选择部门'){
                    params.orgCode = this.searchOrgName
                }
                    ...
                    for(let variable in retData){
                        ...
                        if(retData[variable] != null && retData[variable].length > 0){
                              ...
                              if(userList != null && userList.length > 2){
                                  org["userNum"] = userList.length - 2
                              }
                        }
                        org["orgName"] = variable
                        tableData.push(org)
                    }
            ...
            onPicked(list) {//选中人员的回调
                let retData = list[0]
                this.searchOrgName = retData.title
                this.showPersonPicker = false
            },
            selectPerson(){
