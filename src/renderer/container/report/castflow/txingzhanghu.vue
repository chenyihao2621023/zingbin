<template>
    <div class="txingzhanghu">
        <!-- 头部 -->
        <zing-head :isShowQuery="true" title="T型账户">
        ...
        <div v-transfer-dom>
                ...
                <div style="width: 100%;background-color:#fff;height:100%;margin:3px auto;border-radius:5px;padding-top:3px;">
                    ...
                    <group style="height:70%;">
                        <div style="height:100%;">
                            ...
                            <div>
                                <x-input v-model="form.endSubject" placeholder="请选择" @on-focus="onFocus('endSubject')" class="zdcyClass"></x-input>
                            </div>
            ...
            <cast-flow-change v-bind:recordType="recordType" :showPopup="showMain" @backClick="clickBack" @checkItem="Way"></cast-flow-change>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            Way(item) {
                this.showMain = false
                var url = "/zingbiz/report/finance_report/zhipaiCashFlowProject";
            ...
            cancelCastFlowProject() { //取消现金项目
                ...
                this.$vux.confirm.show({
                    ...
                    onConfirm () {
                        var url = "/zingbiz/report/finance_report/deleteCashFlowProjectStream";
            ...
            getDataList() {
                ...
                var url = "/zingbiz/report/finance_report/castFlow_TAccaout";
