        ...
        <x-dialog
            ...
            <template v-if="showContent">
                ...
                <div v-else class="vux-prompt" >
                    ...
                    <group label-width="4.5em" label-margin-right="2em" label-align="left" v-else>
                        <template v-for="(formAttr, index) in getFormAttrs()">
                            ...
                            <checklist v-if="getFormAttrs()[0].type === 'checklist'"   title="" :options="objectList" v-model="objectListValue" @on-change="_Change"></checklist>
                        </template>
                    </group>
                </div>
            </template>
...
//                msg: '',
        ...
        methods: {
           ...
           /*     if (this.$refs.input) {
            ...
            onShowDialog () {
                console.log('formDialog onShowDialog');
                this.$emit('on-focus');
            },
            _Change (val, label) {
                this.$emit('on-change',val, label);
            }
        }
    }
</script>
