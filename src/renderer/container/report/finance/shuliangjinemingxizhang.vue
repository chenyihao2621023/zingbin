<template>
    <div class="shuliangjinemingxizhang">
        <!-- 头部 -->
        <zing-head :isShowQuery="true" title="数量金额明细账">
    ...
    export default {
        ...
        methods: {
            ...
            getDataList() {
                ...
                console.log("this.form",this.form);
                var url = "/zingbiz/report/finance_report/quantAmountDetail";
            ...
            onExplorExcel() {
                ...
                this.form.explorField = "finance_sljemxz";
                this.form.fileName = "数量金额明细账";
                this.form.fieldTitles = "科目代码@科目名称@日期@凭证字号@摘要@借方单位@借方数量@借方单价@借方金额@贷方单位@贷方数量@贷方单价@贷方金额@期末单位@期末数量@期末单价@方向@期末金额";
                this.form.fields = "subjectId,subjectName,periodTime,pzId,summary,unit_j,amount_j,unitprice_j,money_j,unit_d,amount_d,unitprice_d,money_d,unit_y,amount_y,unitprice_y,direction,money_y";
