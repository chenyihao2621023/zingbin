<template>
    <div class="lirunbiao">
        <!-- 头部 -->
        <zing-head :isShowQuery="true" title="利润表">
    ...
    export default {
        ...
        methods: {
            ...
            getDataList() {
                ...
                var url = "/zingbiz/report/finance_report/report_lirun";
            ...
            onExplorExcel() {
                ...
                this.form.explorField = "finance_lrb";
                this.form.fileName = "利润表";
                this.form.fieldTitles = "项目@本期金额@上期金额";
                this.form.fields = "balance,JF_money,SF_money";
