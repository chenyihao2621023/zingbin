<template>
    <div class="kemuyuebiao">
        <!-- 头部 -->
        <zing-head :isShowQuery="true" title="科目余额表">
    ...
    export default {
        ...
        data() {
            return {
                ...
                restaurantList: [],
                restaurantListAll: [],
                retDateScope: '[1001]库存现金 -- [6901]所得税费用',
                retPeriodScope:'',
                dateTime: '',
        ...
        methods: {
            ...
            getDataList() {
              ...
              this.retPeriodScope = this.form.startPeriod + " 至 " + this.form.endPeriod;
            ...
            onExplorExcel() {
                ...
                this.form.fileName = "科目余额表";
                this.form.fieldTitles = "科目代码@科目名称@期初借方@期初贷方@本期借方@本期贷方@本年借方@本年贷方@期末借方@期末贷方";
                this.form.fields = "subjectCode,subjectName,qc_j,qc_d,bq_j,bq_d,bn_j,bn_d,qm_j,qm_d";
