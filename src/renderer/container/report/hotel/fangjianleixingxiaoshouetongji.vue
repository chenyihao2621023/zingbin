<template>
    <div class="fangjianleixingxiaoshouetongji">
        <!-- 头部 -->
        <zing-head :isShowQuery="true" title="房间类型销售额统计"></zing-head>
        <!-- tab页 -->
...
<script>
    ...
    export default {
        name: "fangjianleixingxiaoshouetongji",
        components: {
        ...
        data() {
            return {
                ...
                retDateScope: '2018-04-19 — 2018-04-23',
                retMoneySum: {},
                curDate: '',
                startDate: '',
                endDate: '',
        ...
        methods: {
            ...
            getDataListByIndex(type) {
                let self = this;
                var url = "/zingbiz/report/restaurant/getZhengTiXiaoShouListById";
                var pat = {};
                if (type != undefined) {
                    if (type != 'zdy') {
                        pat.type = type;
...
<style lang="stylus" rel="stylesheet/stylus" scoped>
    ...
    .fangjianleixingxiaoshouetongji {
        height 100%;
